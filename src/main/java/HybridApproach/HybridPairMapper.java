...
public class HybridPairMapper extends Mapper<LongWritable, Text, HybridWordPair, IntWritable> {
	private HybridWordPair wordPair = new HybridWordPair();
	private HybridWordPair asterixPair = new HybridWordPair();
